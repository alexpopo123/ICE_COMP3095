...
@Slf4j
public class ProductServiceimpl implements ca.gbc.productservice.services.ProductService {
    ...
    public void deleteProduct(String productId) {
        log.info(" Product {} is selected", productId);
        productRepository.deleteById(productId);
    }

    @Override
    public List<ProductResponse> getAllProducts() {
        log.info("Returning a list a products");
